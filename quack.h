...
private:
	...
	int		growBy;						// Array growth factor
	int 	count;						// # of items in array
	int 	front, back;				// Mark front and back index positions
	int 	incr(int i);				// Functions to traverse array indices
	int 	decr(int i);
	void 	growArray(void);			// Function to dynamically expand array
